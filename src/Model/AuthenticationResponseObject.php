 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AuthenticationResponseObject extends ResponseModel implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'AuthenticationResponseObject';
    ...
    /**
     * Sets token
     * @param string $token authentication token (valid for 15 minutes)
     * @return $this
     */
